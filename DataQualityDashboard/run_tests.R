...
install.packages("https://github.com/Feder8-Platform/Honeur-Setup/raw/master/DataQualityDashboard/DataQualityDashboard_1.0.0.tar.gz", repos = NULL, type = "source", INSTALL_opts = c('--no-multiarch'))
