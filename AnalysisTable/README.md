...
2. Download the 'Analysis table creation' script:
    * Linux:
      ```
      curl -L https://raw.githubusercontent.com/Feder8-Platform/Honeur-Setup/master/AnalysisTable/create-analysis-table.sh --output create-analysis-table.sh  && chmod +x create-analysis-table.sh
      ```
    * Windows:
      ```
      curl -L https://raw.githubusercontent.com/Feder8-Platform/Honeur-Setup/master/AnalysisTable/create-analysis-table.cmd --output create-analysis-table.cmd
      ```
