# How to execute the script to add a COVID-19 flag to the analysis table
...
2. Download the script:
      ```curl -L https://raw.githubusercontent.com/Feder8-Platform/Honeur-Setup/master/COVID-19/add-covid-flag.sh --output add-covid-flag.sh  && chmod +x add-covid-flag.sh``` 
