...
3. The HONEUR OMOP CDM database is running in a Docker container named `postgres`:
    ...
    * See [https://github.com/Feder8-Platform/Honeur-Setup/blob/master/OMOPCDM/README.md](https://github.com/Feder8-Platform/Honeur-Setup/blob/master/README.md) for more info.
...
2. Download the installation script:
    * `curl -L https://raw.githubusercontent.com/Feder8-Platform/Honeur-Setup/master/RunETLSMC/runETL.sh --output runETL.sh && chmod +x runETL.sh`
...
3. Download the installation script:
   * `curl -L https://raw.githubusercontent.com/Feder8-Platform/Honeur-Setup/master/RunETLSMC/runETL.cmd --output runETL.cmd`
